...
import com.currencyconverter.service.utilits.Buttons;
import com.currencyconverter.service.utilits.Constants;
import com.currencyconverter.service.utilits.EditMessage;
import com.currencyconverter.service.utilits.MessageBuilder;
import com.currencyconverter.service.utilits.ui.UserServices;
...
public class BotCommands {
    ...
    public void start(long chatId) {
        ...
        messageBuilder.sendMessage(chatId, "Welcome. This bot will help you track current exchange rates!", Buttons.start());
    }

    public void home(long chatId) {
        messageBuilder.sendMessage(chatId, "You have returned to the main menu", Buttons.start());
    }
    ...
    public void settingsMessage(long chatId) {
        messageBuilder.sendMessage(chatId, "Settings", Buttons.setting());
    }
    ...
    public void setMono(long chatId, long messageId) {
        sendMessage.setChatId(chatId);
        getUserSettingsById(chatId).setBank("Mono");
    ...
    public void setPrivat(long chatId, long messageId) {
        sendMessage.setChatId(chatId);
        getUserSettingsById(chatId).setBank("Privat");
    ...
    public void setNBU(long chatId, long messageId) {
        sendMessage.setChatId(chatId);
        getUserSettingsById(chatId).setBank("NBU");
    ...
    public void setTimeOff(long chatId, long messageId){
        sendMessage.setChatId(chatId);
        getUserSettingsById(chatId).setTime("Turn off notifications");
